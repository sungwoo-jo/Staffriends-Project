...
<div class="card" style="margin: 0 auto; width: 90%; height: auto; margin-bottom:10px;" id="card">
    <div class="card-header">
        <h7>작성자: sungwoo11</h7>
        <td><span class="card-text text-right" style="font-size: small; float: right">2023-04-23 21:45:53</span></td>
        </tr>
    </div>
...
<div class="card" style="margin: 0 auto; width: 90%; height: auto; margin-bottom:10px; padding-right: 0;" id="card">
    <div class="card-header">
        <h7>작성자: sungwoo11</h7>
        <td><span class="card-text text-right" style="font-size: small; float: right">2023-04-23 21:50:53</span></td>
        </tr>
    </div>
    <div class="border-bottom" style="border-left: none">
        ...
        <div style="text-align: right; padding-right: 10px;" id="replyControl">
            ...
            <span style="float: right; margin-right: 10px;"><a href="javascript:showReplyForm()" style="color: #007bff"
                                                               id="addReply">댓글달기</a></span>
        </div>
    </div>
    <replyAdd></replyAdd>
